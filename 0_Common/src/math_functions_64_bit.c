...
int shift_left_uint64(uint64_t   operand_1,
                      uint64_t   operand_2,
                      uint64_t * p_result)
{
    int exit_code = E_FAILURE;
...
int shift_right_uint64(uint64_t   operand_1,
                       uint64_t   operand_2,
                       uint64_t * p_result)
{
    int exit_code = E_FAILURE;
...
int rotate_left_uint64(uint64_t   operand_1,
                       uint64_t   operand_2,
                       uint64_t * p_result)
{
    int exit_code = E_FAILURE;
...
int rotate_right_uint64(uint64_t   operand_1,
                        uint64_t   operand_2,
                        uint64_t * p_result)
{
    int exit_code = E_FAILURE;
